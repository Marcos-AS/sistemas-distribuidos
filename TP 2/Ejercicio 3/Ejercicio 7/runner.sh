...
curl -X POST http://34.133.140.6:8080/api/taskmanager/createTask -H 'Content-Type: application/json' -d '{"taskName":"add2num","fullContainerImage":"marcos1as/imagen-ej7", "parameters":{"numA":"10","numB":"25"}}'
