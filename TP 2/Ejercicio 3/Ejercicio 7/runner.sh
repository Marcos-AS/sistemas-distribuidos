...
curl -X POST http://localhost:8092/api/taskmanager/createTask -H 'Content-Type: application/json' -d '{"taskName":"add2num","fullContainerImage":"marcos1as/imagen-ej7", "parameters":{"numA":"10","numB":"25"}}'
