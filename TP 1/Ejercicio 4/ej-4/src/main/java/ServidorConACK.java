                        ...
                        switch (opcion) {
                            case "1":
                                ...
                                if (!colaMensajes.isEmpty()) {
                                    ...
                                    output.println("Por favor confirme que ha recibido los mensajes (escriba ack)");
                                    String respuesta = input.readLine();
                                    if(respuesta.equalsIgnoreCase("ack")){
                                        // Borramos los mensajes de la cola
                                        colasMensajes.remove(nombreUsuario);
                                        colasMensajes.put(nombreUsuario, new LinkedList<>());
